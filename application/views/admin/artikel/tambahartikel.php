...
<div class="container">
	<h4>Silakan Anda Masukkan Artikel Anda!!</h4>
	<hr>
		<form action="<?php echo site_url('admin/tambahartikel') ?>" role="form" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="date" name="tanggalupdate" class="form-control" value=" " placeholder="Tanggal" >
			</div>
			<div class="form-group">
