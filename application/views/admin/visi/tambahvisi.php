...
<div class="container">
<h4>Silakan Anda Masukkan Visi Dan Misi anda!!</h4>
<hr>
<form action="<?php echo site_url('admin/tambahvisi') ?>" role="form" method="post">
...
<div class="form-group">
		<label for="isi">Isi Visi Dan Misi</label>
